    ...
    <aside className="sidebar-widgets">
      ...
      <div className="social-follow purple-bg text-white text-center p-3 border">
        ...
        <div className="d-flex justify-content-center gap-2">
          <Link to="#"><img src="/images/facebook-icon.png" alt="Facebook" width="30" /></Link>
          <Link to="#"><img src="/images/twitter-icon.png" alt="Twitter" width="30" /></Link>
          <Link to="#"><img src="/images/youtube-icon.png" alt="YouTube" width="30" /></Link>
        </div>
      </div>
    </aside>
  );
